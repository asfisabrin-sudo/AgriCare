...
💡To find your SQL Server instance name: open SSMS → the name shown at connection time 
       (e.g. YOURPC\SQLEXPRESS), or run sqlcmd -L in Command Prompt.
...
Manager	    (registration disabled
            -- seed directly in DB / 
             via script)                 ---	       See Users table in script.sql 
